    ...
    e.TRANSITION_DURATION = 350,
        ...
        e.prototype.init = function () {
            ...
            this.options.doubleTapToGo && this.$element.find("li." + c).has("ul").children("a").addClass("doubleTapToGo"),
                ...
                this.$element.find("li").not("ul").not(".secondLi").children("a").on("click.metisMenu", function(d){
                    var g = b.$element.find("li." + c).has("ul").children("ul");
                    b.hide(g);
                    return void 0;
                }),
                this.$element.find(".linkLi").on("click.metisMenu", function(d){
                    b.$element.find(".linkLi").removeClass(c);
                    a(this).addClass(c);
                });
        },
        ...
        e.prototype.hide = function (b) {
            ...
            if (!this.transitioning && f.hasClass("in")) {
                ...
                if(!$("body").hasClass("mini-navbar")){
                    f.addClass("collapsing").removeClass("collapse");
                }
                f.removeClass("in");
                this.transitioning = 1;
                var g = function () {
